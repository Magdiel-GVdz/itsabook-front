    ...
    return (
        <form onSubmit={onsubmit}>
            ...
            {...register("correo", {
                ...
                pattern: {
                    value: /^[a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ._%+-]+@[a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ.-]+\.[a-zA-Z]{2,}$/,
            ...
            {...register("contraseña", {
                ...
                validate: (value) => {
                    const passwordRegex = /^(?=.*[a-záéíóúüñ])(?=.*[A-ZÁÉÍÓÚÜÑ])(?=.*\d)(?=.*[!@#$%^&*])[a-zA-Z\d!@#$%^&*]{8,}$/;
                    return passwordRegex.test(value) || "La contraseña debe tener al menos 8 caracteres, una mayúscula, una minúscula, un número y un símbolo especial: !@#$%^&*";
                }
            })}/>
